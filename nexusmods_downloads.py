...
output_dir = r"K:\Thesis Data\Sample B\Nexus Mods\Sample B - Nexus downloads"
...
for nexus_id in df["nexus_id"]:
    url = f"https://staticstats.nexusmods.com/mod_monthly_stats/{nexus_id}.json"
    output_path = f"{output_dir}/{nexus_id}.json"
    ...
    print(f"File saved: {nexus_id}.json")
